    ...
    module Drops
      class Page < Base
        ...
        def editable_elements
        	puts ::Page.criteria.id(@source.id).first.attributes.inspect
        	puts "..........."
        	puts ::Page.criteria.id(@source.id).first.attributes.to_a.inspect
        	puts "..........."
        	puts ::Page.criteria.id(@source.id).first.attributes.class
        	puts "-------------"
