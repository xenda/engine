class ContentType
  ...
  def ordered_events
  	self.contents.select { |c| (!c.custom_field_8.to_s.empty? && !c.custom_field_9.to_s.empty?) && (c.custom_field_8 >= Date.today || c.custom_field_9 >= Date.today) }.sort_by{ |c| c.custom_field_8 }
  end
